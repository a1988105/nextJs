    ...
    <div className="max-w-2xl mx-auto px-6 py-12">
      ...
      <div className="fade-up delay-1 flex items-start justify-between mb-10">
        ...
        <div className="text-right">
          <p className="text-xs text-gray-600 mb-1">Store 狀態</p>
      ...
      {/* Holdings */}
      <div className="fade-up delay-3 rounded-2xl border border-white/[0.07] bg-white/[0.02] p-6">
      ...
      {/* Architecture note */}
      <div className="fade-up delay-4 mt-6 rounded-xl border border-white/[0.05] bg-white/[0.01] px-5 py-4">
